...
public class LogWriter {
    ...
    public static final String PATH = Environment.getExternalStorageDirectory().getAbsolutePath() + "/GZJX/log/";
    ...
    public static synchronized void writeLog(Context context, Throwable ex, File file, String time, WriteCallback writeCallback) {
        ...
        try {
            ...
            e.printStackTrace();
            Logger.e("write crash exception failed");
        }
    }
