package com.jess.arms.utils.utilcode.util;
...
//           Bitmap bitmap = BitmapFactory.decodeFile(filePath, options);
            ...
            int scale = 1;
            if (trueWidth / PHOTO_COMPRESS_MAX_WIGTH > trueHeigth /PHOTO_COMPRESS_MAX_HEIGHT&&trueWidth> PHOTO_COMPRESS_MAX_WIGTH) {
                scale = trueWidth / PHOTO_COMPRESS_MAX_WIGTH;
            } else if (trueHeigth > PHOTO_COMPRESS_MAX_HEIGHT) {
                scale = trueHeigth / PHOTO_COMPRESS_MAX_HEIGHT;
            }
